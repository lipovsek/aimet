...
class TransformerModel(nn.Module):
    ...
    def _generate_square_subsequent_mask(self, sz):
        ...
        mask = (
            mask.float().masked_fill(mask == 0, -6).masked_fill(mask == 1, float(0.0))
        )
        return mask
