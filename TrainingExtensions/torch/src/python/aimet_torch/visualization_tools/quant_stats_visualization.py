...
def _visualize(
    ...
    if not isinstance(sim, QuantizationSimModel):
        raise TypeError(
            f"Expected type 'aimet_torch.quantsim.QuantizationSimModel', got '{type(sim)}'."
        )
...
def visualize_stats(
    ...
    Example:
        ...
        >>> sim = aimet_torch.quantsim.QuantizationSimModel(model, dummy_input, quant_scheme=QuantScheme.post_training_tf)
...
def visualize_advanced_stats(
    ...
    Example:
        ...
        >>> sim = aimet_torch.quantsim.QuantizationSimModel(model, dummy_input, quant_scheme=QuantScheme.post_training_tf_enhanced)
        >>> with aimet_torch.nn.compute_encodings(sim.model):
        ...     for data, _ in data_loader:
        ...         sim.model(data)
        ...
