...
class TestQuantAnalyzer:
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            for quant_wrapper_name in layer_wise_eval_score_dict.keys():
                ...
                assert os.path.isfile(
                    os.path.join(tempdir, "per_layer_quant_enabled.html")
                )
    ...
    def test_perform_per_layer_analysis_by_disabling_quant_wrappers(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            # Check if it is exported to correct html file.
            assert os.path.isfile(
                os.path.join(tempdir, "per_layer_quant_disabled.html")
            )
    ...
    def test_export_per_layer_stats_histogram(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            assert os.path.exists(
                os.path.join(tempdir, "activations_pdf/conv1_input_q0_0.html")
            )
            assert os.path.exists(
                os.path.join(tempdir, "weights_pdf/conv1/conv1_weight_0.html")
            )
    ...
    def test_export_per_layer_stats_histogram_per_channel(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            assert os.path.exists(os.path.join(tempdir, "weights_pdf"))
            assert os.path.exists(
                os.path.join(tempdir, "activations_pdf/bn1_output_q0_0.html")
            )
            assert os.path.exists(
                os.path.join(tempdir, "weights_pdf/conv1/conv1_weight_0.html")
            )
            assert os.path.exists(
                os.path.join(tempdir, "weights_pdf/conv1/conv1_weight_31.html")
            )
            assert os.path.exists(
                os.path.join(tempdir, "weights_pdf/conv2/conv2_weight_0.html")
            )
            assert os.path.exists(
                os.path.join(tempdir, "weights_pdf/conv2/conv2_weight_15.html")
            )
    ...
    def test_export_per_layer_encoding_min_max_range(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            assert os.path.isfile(
                os.path.join(tempdir, "min_max_ranges/activations.html")
            )
    ...
    def test_export_per_layer_encoding_min_max_range_per_channel(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            assert os.path.isfile(
                os.path.join(tempdir, "min_max_ranges/conv1_weight.html")
            )
