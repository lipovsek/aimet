...
def patch_ptq_techniques(
    ...
    with (
        patch(
            "aimet_torch.v1.auto_quant.QuantizationSimModel",
        ...
        patch(
            "aimet_torch.v1.auto_quant.Adaround._apply_adaround", side_effect=adaround
        ) as mock_adaround,
        patch(
            "aimet_torch.v1.auto_quant.GreedyMixedPrecisionAlgo",
...
def patch_dependencies():
    ...
    with (
        patch(
            "aimet_torch.v1.auto_quant.create_pareto_curve",
            side_effect=bokeh_model_factory,
        ),
        patch(
            "aimet_torch.v1.auto_quant.create_sensitivity_plot",
            side_effect=bokeh_model_factory,
        ),
    ):
        yield
    ...
    def test_auto_quant_fallback(
        ...
        with patch_ptq_techniques(
            ...
            with create_tmp_directory() as results_dir:
                ...
                with patch(
                    "aimet_torch.v1.auto_quant.Adaround._apply_adaround",
                    side_effect=error_fn,
                ):
