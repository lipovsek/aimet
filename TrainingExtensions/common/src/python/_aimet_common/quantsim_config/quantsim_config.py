...
from ..defs import QuantizationDataType, QuantDtypeBwInfo, qtype
from ..connected_graph.operation import Op
from ..graph_pattern_matcher import PatternType
from ..quantsim_config.json_config_importer import (
    JsonConfigImporter,
    ConfigDictKeys,
    DefaultsType,
    ParamType,
...
_config_file_aliases = {
    ...
    #   - enpu_quantsim_config_v7_per_channel.json (per-channel)
    #
    # "enpu_v7" points to the per-tensor config file
    # as it's more performant and supports more supergroups
    "enpu_v7": "enpu_quantsim_config_v7.json",
}
