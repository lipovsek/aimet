...
class Gemma3_ONNX(Gemma3_VLM):
    """Gemma3 ONNX quantization (text backbone + vision tower)."""
        ...
        **kwargs,
        ...
        if is_hf:
            ...
            raise NotImplementedError(
                "Loading Gemma3 ONNX from non-HuggingFace checkpoint not yet supported."
            )
